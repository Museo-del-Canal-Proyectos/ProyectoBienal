        ...
        b.isMobile && b.pdfBrowserViewerIfMobile && b.pdfUrl
          ? b.lightBox && !b.lightBoxOpened
            ? this.$elem
                ...
                .css("cursor", "pointer")
            : f()
          : b.isIE && b.pdfBrowserViewerIfIE && b.pdfUrl
          ? b.lightBox && !b.lightBoxOpened
            ? this.$elem
                .on("touched click", function () {
                  f();
    ...
    (FLIPBOOK.Main.prototype = {
          ...
          1 == this.Book.view
            ...
            : (s > i || (s == i && i % 2 == 0)
                ...
                : ((e = String(s) + "-" + String(s + 1)),
                  this.options.cover || (e = String(s - 1) + "-" + String(s)),
                  (this.cPage = [s - 1, s])),
              this.options.cover ? this.setHash(s) : this.setHash(s - 1)),
          o
            ? (this.enableNext(s > 0),
        ...
        if (!this.started) {
          ...
          if (
            (e.options.pdfUrl
              ...
              : e.options.pdfBase64 && (o.data = atob(e.options.pdfBase64)),
          ...
          if (!this.pdfinitStarted)
            (this.pdfinitStarted = !0),
              pdfjsLib.getDocument(o).promise.then(
                function (t) {
                  (e.pdfDocument = t),
                    (e.pdfService = new FLIPBOOK.PdfService(t, e, e.options)),
      ...
      createBook: function () {
        ...
        if (
          ...
          for (
            var o = [e.options.pages[0]], i = 1;
            i <= e.options.pages.length - 2;
            i++
          ) {
            var n = {
          ...
          if (e.options.backCover)
            o.push(e.options.pages[e.options.pages.length - 1]);
          else {
            var a;
            (n = {
        ...
        if (
          ...
          for (i = 0; i < e.options.pages.length; i++)
            void 0 !== e.options.pages[i].htmlContent &&
              ((e.options.hasHtmlContent = !0),
              (e.options.pages[i].htmlContent = jQuery(
                '<div class="flipbook-page-htmlContent">' +
                  e.options.pages[i].htmlContent +
                  "</div>"
              )));
        function r() {
          e.options.flipSound &&
        ...
        if ("webgl" == e.options.viewMode) {
          ...
          (l.scroll = e.scroll),
            (l.parent = e),
            (e.Book = new FLIPBOOK.BookWebGL(e.book[0], this, l)),
            (e.webglMode = !0),
            e.initSwipe(),
            r();
        } else
          "swipe" == e.options.viewMode
            ...
            : ("2d" != e.options.viewMode && (e.options.viewMode = "3d"),
              (e.Book = new FLIPBOOK.Book3(e.book[0], this, t)),
              e.initSwipe(),
              (e.webglMode = !1),
              r());
        this.resize(),
              ...
              switch (
                ...
                case "youtube":
                  s.url.includes("<iframe")
                    ...
                    : (s.url.includes("youtu.be/") &&
                      ...
                      s.url.includes("youtube.com/watch?v=") &&
                        (s.url = s.url
                          .split("&")[0]
                ...
                case "link":
                  (o = jQuery(
                    ...
                    .width(s.width)
                    .height(s.height)
                    .css({ position: "absolute", top: s.y, left: s.x })),
                    s.content && o.html(s.content),
                    s.url
                      ? o
                          .attr("href", s.url)
                          .attr("target", s.target || this.options.linkTarget)
                      : s.page &&
                        o
                          .attr("href", "#")
      ...
      createButton: function (e) {
        ...
        (g.$icon = this.createIcon(e).appendTo(g)),
          m(g.$icon),
          e.iconAlt2 &&
            ((g.$iconAlt = this.createIcon(e, !0).appendTo(g).hide()),
            m(g.$iconAlt)),
          (g.icon = e.iconFA),
      ...
      createTocItem: function (e, t, i) {
        ...
        var r = jQuery(o.createElement("span"))
          ...
          l = jQuery("<span>")
            ...
            .appendTo(r)
            .addClass(
              "flipbook-icon-angle-" + (s ? "left" : "right") + " skin-color"
            )
            .hide(),
          h = jQuery("<span>")
            .attr("aria-hidden", "true")
      ...
      toggleShareMenu: function () {
        if (this.shareMenu)
          ...
          var n = this.options,
            s = jQuery('<div class="flipbook-share"><ul></ul></div>')
              .appendTo(i)
              .find("ul"),
              ...
              jQuery(
                ...
                .bind("tap click", function (e) {
                  ...
                  switch (i) {
                    ...
                    case "whatsapp":
                      o = n.isMobile
                        ? "whatsapp://send?text=" + s + "%20" + l
                        : "https://wa.me?text=" + s + "%20" + l;
                  }
                  t.open(
                    o,
                    "Share",
            ...
            if ("" != e) {
              ...
              if (
                ...
                for (var a = 0; a < i.pdfInfo.numPages; a++)
                  i.findInPage(e, a, function (o, i, a, r) {
                    o.length > 0 &&
                      (t.pagesFound++,
                      (s += o.length),
                      t.$findInfo.show().text(s + " " + n.strings.matchesFound),
                      t.main.mark(e),
                ...
                for (a = 0; a < n.pagesOriginal.length; a++) {
                  var r = a;
                  n.doublePage && (r *= 2),
                    n.doublePage && r == 2 * n.pagesOriginal.length - 2 && r--,
    ...
    function t(t, T) {
          ...
          if (
            ...
            return (
              ...
              !l || xe === T.fingers || T.fingers === m || R()
                ? ((ye = se()),
                  2 == xe &&
                    (Y(1, l[1]), (fe = me = ie(Oe[0].start, Oe[1].start))),
                  (T.swipeStatus || T.pinchStatus) && (r = A(a, Be)))
                : (r = !1),
              !1 === r
                ? (A(a, (Be = S)), r)
                : (T.hold &&
                    (Fe = setTimeout(
                      e.proxy(function () {
                        Se.trigger("hold", [a.target]),
                          T.hold && (r = T.hold.call(Se, a, a.target));
                      }, this),
                      T.longTapThreshold
                    )),
                  X(!0),
      ...
      function C(t) {
        ...
        if (Be !== P && Be !== S && !G()) {
          ...
          if (
            ...
            2 == xe &&
              (0 == fe
                ? (Y(1, v[1]), (fe = me = ie(Oe[0].start, Oe[1].start)))
                : (J(v[1]),
            ...
            if (
                  ...
                  if (T.allowPageScroll === l) e.preventDefault();
                    ...
                    switch (t) {
                      ...
                      case i:
                        ...
                        break;
                      case n:
                        ((T.swipeUp && a) || (!a && T.allowPageScroll != f)) &&
                          e.preventDefault();
                        break;
                      case s:
                        ((T.swipeDown && a) ||
                          (!a && T.allowPageScroll != f)) &&
                          e.preventDefault();
                    }
                  }
              ...
              !T.triggerOnTouchEnd && x
                ? (Be = E(w))
                : T.triggerOnTouchLeave && !x && (Be = E(P)),
                (Be != S && Be != P) || A(g, Be);
            }
          } else A(g, (Be = S));
          !1 === k && A(g, (Be = S));
      ...
      function L(e) {
        ...
        return (
          ...
          D() || !Q()
            ? A(t, (Be = S))
            : T.triggerOnTouchEnd || (!1 === T.triggerOnTouchEnd && Be === w)
      ...
      function A(e, t) {
        ...
        return (
          ...
          Z() && U() && !1 !== o
            ? (o = j(e, t, u))
            : be > T.longTapThreshold && ce < k && T.longTap && !1 !== o
            ? (o = j(e, t, g))
            : !((1 !== xe && B) || !(isNaN(ce) || ce < T.threshold) || !$()) &&
              !1 !== o &&
              (o = j(e, t, c)),
          t === S && I(),
          t === P && ((i && i.length) || I()),
        ...
        if (h == d) {
          ...
          if (l == P && N()) {
            if (
              ...
              T.swipe &&
                !1 === (b = T.swipe.call(Se, t, ue, ce, be, xe, Oe, ge)))
            )
              return !1;
            switch (ue) {
              case o:
                Se.trigger("swipeLeft", [ue, ce, be, xe, Oe, ge]),
                  T.swipeLeft &&
                    (b = T.swipeLeft.call(Se, t, ue, ce, be, xe, Oe, ge));
                break;
              case i:
                Se.trigger("swipeRight", [ue, ce, be, xe, Oe, ge]),
                  T.swipeRight &&
                    (b = T.swipeRight.call(Se, t, ue, ce, be, xe, Oe, ge));
                break;
              case n:
                Se.trigger("swipeUp", [ue, ce, be, xe, Oe, ge]),
                  T.swipeUp &&
                    (b = T.swipeUp.call(Se, t, ue, ce, be, xe, Oe, ge));
                break;
              case s:
                Se.trigger("swipeDown", [ue, ce, be, xe, Oe, ge]),
                  T.swipeDown &&
                    (b = T.swipeDown.call(Se, t, ue, ce, be, xe, Oe, ge));
            }
          }
        }
        if (h == p) {
        ...
        return (
          h == c
            ...
            ? (l !== S && l !== P) ||
              ...
              T.doubleTap && (b = T.doubleTap.call(Se, t, t.target)))
            : h == g &&
              ((l !== S && l !== P) ||
                (clearTimeout(Ie),
                (Le = null),
                Se.trigger("longtap", [t.target]),
                T.longTap && (b = T.longTap.call(Se, t, t.target)))),
          b
        );
      }
      function Q() {
