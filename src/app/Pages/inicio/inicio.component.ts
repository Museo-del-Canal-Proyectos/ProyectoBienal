...
export class InicioComponent {
  ...
  brooke() {
    Swal.fire({
      ...
      background: 'url(images/Artista_ESP/BrookeEspanol.jpg)', // Fondo del modal
  ...
  Cisco() {
    Swal.fire({
      text: "", // Texto del modal 
      background: 'url(images/Artista_ESP/CiscoEspanol.jpg)', // Fondo del modal
      confirmButtonText: '<i class="fa-solid fa-rectangle-xmark"></i>', // Texto y icono del botón de confirmación
      confirmButtonColor: '#ffffff', // Color del fondo del botón
      backdrop: 'rgba(0, 0, 0, 0.9)',
      customClass: {
  ...
  Giana() {
    Swal.fire({
      text: "", // Texto del modal 
      background: 'url(images/Artista_ESP/GianaEspanol.jpg)', // Fondo del modal
      confirmButtonText: '<i class="fa-solid fa-rectangle-xmark"></i>', // Texto y icono del botón de confirmación
      confirmButtonColor: '#ffffff', // Color del fondo del botón
      backdrop: 'rgba(0, 0, 0, 0.9)',
      customClass: {
